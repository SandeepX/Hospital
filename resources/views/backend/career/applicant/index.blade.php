...
@section('main-content')
    ...
    <section class="content">
                        ...
                        <div class="row align-items-center mt-2">
                            ...
                            <div class="col-lg-3 col-md-3">
                                <div class="d-flex justify-content-between">
                                    <button type="submit" class="btn btn-block btn-primary form-control me-2">Filter</button>
                                    <a href="{{route('career-applicants.export')}}" class="btn btn-block btn-primary form-control export">Export</a>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        @include('backend.career.applicant.show')
