    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '#showDescription', function (event) {
            ...
            $.get(url, function (data) {
                ...
                $('.modal-title').html(data.data.name+ ' Testimonial Description');
                $('#testimonialDescription').text(data.data.description);
        ...
        $('.toggleStatus').change(function (event) {
            ...
            Swal.fire({
                title: 'Are you sure you want to change Testimonial Publish Status ?',
                showDenyButton: true,
        ...
        $('.deleteTestimonial').click(function (event) {
            ...
            Swal.fire({
                title: 'Are you sure you want to Delete this Testimonal ?',
                showDenyButton: true,
                confirmButtonText: `Yes`,
                denyButtonText: `No`,
                padding:'10px 50px 10px 50px',
