                            ...
                            <table id="dataTableExample" class="table">
                                ...
                                @forelse($departments as $key => $value)
                                    <tr>
                                        ...
                                        <td>{{date('d M Y',strtotime($value->dept_opened))}}</td>
                                        <td>
                                            <img  src="{{asset(\App\Models\Department::UPLOAD_PATH.'Thumb-'.$value->image)}}"
                                                  alt="alt" >
                                        </td>
                                        <td>
                                            <a href=""
                                               id="showDescription"
                                               data-href="{{route('departments.show',$value->id) }}"
                                        ...
                                        <td>
                                            <label class="switch">
                                                <input class="toggleStatus" href="{{route('departments.toggle-status',$value->id)}}"
                                            ...
                                            <ul class="d-flex list-unstyled mb-0">
                                                ...
                                                <li>
                                                    <a class="deleteDepartment"
                                                       data-href="{{route('departments.delete',$value->id)}}">
...
{{--        </div>--}}
    ...
    @include('backend.department.show')
@endsection
