    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '#showDescription', function (event) {
            ...
            $.get(url, function (data) {
                ...
                $('.modal-title').html('Our International Patient : '+ data.data.name);
                $('#detailDescription').text(data.data.description);
        ...
        $('.deleteRecord').click(function (event) {
            ...
            Swal.fire({
                title: 'Are you sure you want to Delete this Patient Detail?',
                showDenyButton: true,
                confirmButtonText: `Yes`,
                denyButtonText: `No`,
                padding:'10px 50px 10px 50px',
